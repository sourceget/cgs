...
return [
    ...
    'guard' => 'admin',
    'models' => [
        'apiKey' => \App\Entities\ApiKey::class,
        'apiLog' => \App\Entities\ApiLog::class,
    ],
    /*
      |--------------------------------------------------------------------------
      | Key name
    ...
    /*
      ...
      |
     */
    'methodLimitIncrement' => '1 minutes',
    'providers' => [
        ...
        /*
          ...
          |
         */
        'auth' => App\Supports\Auth\ApiGuard::class
    ]
];
